...
Protected Module TOMLKit
	...
	#tag Method, Flags = &h1, Description = 52657475726E7320606B65796020616E64206076616C756560206173206120544F4D4C20666F726D6174746564206B65792D76616C756520706169722E
		Protected Function KeyValue(key As String, value As Boolean) As String
		  /// Returns `key` and `value` as a TOML formatted key-value pair.
	...
	#tag Method, Flags = &h1, Description = 52657475726E7320606B65796020616E64206076616C756560206173206120544F4D4C20666F726D6174746564206B65792D76616C756520706169722E
		Protected Function KeyValue(key As String, value As Color) As String
		  /// Returns `key` and `value` as a TOML formatted key-value pair.
		  
		  Return key + " = " + GenerateJSON(value.ToString)
		  
		End Function
	#tag EndMethod

	#tag Method, Flags = &h1, Description = 52657475726E7320606B65796020616E64206076616C756560206173206120544F4D4C20666F726D6174746564206B65792D76616C756520706169722E
		Protected Function KeyValue(key As String, value As Double) As String
		  /// Returns `key` and `value` as a TOML formatted key-value pair.
	...
	#tag Method, Flags = &h1, Description = 52657475726E7320606B65796020616E64206076616C756560206173206120544F4D4C20666F726D6174746564206B65792D76616C756520706169722E
		Protected Function KeyValue(key As String, value As Integer) As String
		  /// Returns `key` and `value` as a TOML formatted key-value pair.
	...
	#tag Method, Flags = &h1, Description = 52657475726E7320606B65796020616E64206076616C756560206173206120544F4D4C20666F726D6174746564206B65792D76616C756520706169722E
		Protected Function KeyValue(key As String, value As String) As String
		  /// Returns `key` and `value` as a TOML formatted key-value pair.
	...
	#tag Constant, Name = VERSION_MINOR, Type = Double, Dynamic = False, Default = \"1", Scope = Private, Description = 546865206D696E6F722076657273696F6E2E
	#tag EndConstant

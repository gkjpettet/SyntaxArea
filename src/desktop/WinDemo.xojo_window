...
#tag WindowCode
	...
	#tag Constant, Name = EXAMPLE_OBJO, Type = String, Dynamic = False, Default = \"class Person {\n# This is a comment.\n}", Scope = Protected
	#tag EndConstant
...
#tag Events PopupDefinition
	#tag Event
		Sub Opening()
		  ...
		  Me.SelectedRowIndex = xojoDefIndex
...
#tag Events PopupExampleText
	#tag Event
		Sub Opening()
		  ...
		  // ObjoScript.
		  Me.AddRow("Objo")
		  Me.RowTagAt(Me.LastAddedRowIndex) = EXAMPLE_OBJO
		  ...
		  Var xojoTextIndex As Integer = Me.LastAddedRowIndex
		  
		  // Start with Xojo text.
		  Me.SelectedRowIndex = xojoTextIndex
		End Sub
	#tag EndEvent
	#tag Event
		Sub SelectionChanged(item As DesktopMenuItem)

...
#tag WindowCode
	...
	#tag Event
		Sub Opening()
		  ...
		  For i As Integer = 0 To PopupDefinition.LastRowIndex
		    If PopupDefinition.RowTextAt(i) = "Markdown" Then
		  ...
		  For i As Integer = 0 To PopupTheme.LastRowIndex
		    If PopupTheme.RowTextAt(i) = "Markdown Light" Then
		      PopupTheme.SelectedRowIndex = i
		      Exit
		    End If
		  Next i
		  
		  CodeEditor.Text = DEBUG_MARKDOWN
		End Sub
	#tag EndEvent
	...
	#tag Constant, Name = DEBUG_MARKDOWN, Type = String, Dynamic = False, Default = \"[inlineLinkText](inlineLinkDestination)\n[linkText][linkDestination]\n[inlineLinkText](inlineLinkDestination-Hyphen) should \x3D inlineLinkDestination\n[linkText][linkDestination-Hyphen] should \x3D linkDestination\n[referenceLinkText]: http:google.com\n\ninlineLinkText: Grey bold underline\ninlineLinkDestination: Green underline\nlinkText: Pink italic\nlinkDestination: Blue\n\ninlineLink: Cyan\nbracketedLinkDestination: Red\n", Scope = Public
	#tag EndConstant
...
#tag Events PopupTheme
	#tag Event
		Sub Opening()
		  ...
		  // Markdown Light.
		  Me.AddRow("Markdown Light")
		  theme = SyntaxArea.EditorTheme.FromFile(SpecialFolder.Resource("Markdown Light.json"))
		  Me.RowTagAt(Me.LastAddedRowIndex) = theme

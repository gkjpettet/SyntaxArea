...
Protected Module SyntaxArea
	...
	#tag Method, Flags = &h0, CompatibilityFlags = API2Only and ( (TargetIOS and (Target64Bit)) or  (TargetAndroid and (Target64Bit)) ), Description = 52657475726E7320746865206368617261637465722077686F736520556E69636F646520636F646520706F696E74206973207061737365642E
		Function Chr(codePoint As Integer) As String
		  /// Returns the character whose Unicode code point is passed.
		  ///
		  /// Exists because Xojo Inc haven't implemented this basic global function in the 
		  /// mobile framework yet.
		  
		  Return Encodings.UTF8.Chr(codePoint)
		End Function
	#tag EndMethod
